function openModal(cupcake) {
  ...
  switch (cupcake) {
    case "CupFlavor1":
      txt1.innerHTML  = "Delicinha de morango";
      txt2.innerHTML  = "Um delicioso sabor de morango estragado.";
      txt3.innerHTML  = "R$9.90";
      break;
    case "CupFlavor2":
      txt1.innerHTML  = "Delicinha de abacaxi";
      txt2.innerHTML  = "Um delicioso sabor de abacaxi azedo.";
      txt3.innerHTML  = "R$9.90";
      break;
    case "CupFlavor3":
      txt1.innerHTML  = "Algodão doce";
      txt2.innerHTML  = "Um delicioso sabor de algodão doce.";
      txt3.innerHTML  = "R$9.90";
      break;
    case "CupFlavor4":
      txt1.innerHTML  = "Floresta negra";
      txt2.innerHTML  = "Um delicioso sabor de chocolate amargo.";
      txt3.innerHTML  = "R$12.90";
      break;
    case "CupFlavor5":
      txt1.innerHTML  = "Delicinha de limão";
      txt2.innerHTML  = "Um delicioso sabor de limão.";
      txt3.innerHTML  = "R$12.90";
      break;
    case "CupFlavor6":
      txt1.innerHTML  = "Limonada de morango";
      txt2.innerHTML  = "Um delicioso sabor de morango azedo.";
      txt3.innerHTML  = "R$12.90";
      break;
