...
data = pd.read_csv('C:/RN/base_veiculos_2.csv')
...
taxa_aprend_rnc1 = 0.30
taxa_aprend_rnc2 = 0.50
...
# Ordem do PolinÃ´mio para RegressÃ£o EficiÃªncia X CO2
ordem_pol3 = 4
...
# Informe um valor de EficiÃªncia (em Km/L) para prever a EmissÃ£o de CO2 (em g/Km)
...
# CriaÃ§Ã£o da Rede Neural Competitiva 3
...
# Realizar a prediÃ§Ã£o kmpl x co2
...
# CÃ¡lculo do polinÃ´mio para EficiÃªncia X EmissÃ£o de CO2
...
#------------------------------------------------------------------------------
# Prever o valor de EmissÃ£o de CO2 correspondente a EficiÃªncia informada
...
#------------------------------------------------------------------------------
# EficiÃªncia (Km/L) X EmissÃ£o de CO2 (g/Km)
...
ax.set_xlabel("EficiÃªncia (Km/L)")
ax.set_ylabel("EmissÃ£o de CO2 (g/Km)")
ax.set_title("EficiÃªncia X EmissÃ£o de CO2")
...
print('\n' * 2)
#------------------------------------------------------------------------------
# Tabela Cilindrada (L) X EmissÃ£o de CO2 (g/Km)
...
print('\n' * 2)
#------------------------------------------------------------------------------
# Tabela EficiÃªncia (Km/L) X EmissÃ£o de CO2 (g/Km)
print("Tabela 3. EficiÃªncia (Km/L) X EmissÃ£o de CO2 (g/Km)")
print('_' * 70)
...
# Imprimir resultados da funÃ§Ã£o f(x) para Cilindrada X EmissÃ£o de CO2
...
# Imprimir resultados da funÃ§Ã£o f(x) para EficiÃªncia X EmissÃ£o de CO2
print('FunÃ§Ã£o polinomial para EficiÃªncia X EmissÃ£o de CO2')
print('_' * 70)
print(function_str3 + '\n')
print("EficiÃªncia informada:", eficiencia_info, "Km/L")
print("EmissÃ£o de CO2 prevista:", previsao_y3, "g/Km")
print('_' * 70)
print('\n' * 1)
#==============================================================================